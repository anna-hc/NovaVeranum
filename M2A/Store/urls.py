...
urlpatterns = [
    ...
    path('<int:idHab>/', views.verHab, name='verJuego'),
    ...
    path('eliminarJuego/<int:idHab>', views.eliminarHab, name='eliminarJuego'),
    path('registroHab/<int:idHab>', views.modificarHab, name='modificarJuego'),
    path('subirJuego', views.subirHab, name='subirJuego'),
